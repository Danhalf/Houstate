class PhoneField {
   constructor(a, b = '+38(___)___-____', c = '_') {
      (this.handler = a),
         (this.mask = b),
         (this.placeholder = c),
         this.setLength(),
...
document.addEventListener('DOMContentLoaded', () => {
   document.querySelectorAll('.masked-phone').forEach(elem => {
      new PhoneField(elem, elem.dataset.phonemask, elem.dataset.placeholder)
   })
